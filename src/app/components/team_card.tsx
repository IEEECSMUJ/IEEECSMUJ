...
export function ECTeamCard() {
    return(
        <>
            <div>
                <div className='mx-auto w-64 bg-ieeeorange bg-opacity-10 border-ieeeorange rounded-xl'>
...
export function CCTeamCard() {
    return(
        <>
            <div>
                <div className='mx-auto w-64 bg-ieeeorange bg-opacity-10 border-ieeeorange rounded-full'>
